        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <span>+62 086 000 000?</span>
                </div>
                <div class="h-100 d-inline-flex align-items-center">
                    <span class="far fa-envelope me-2"></span>
                    <span>KebunKu@gmail.com</span>
                </div>
            </div>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">Buat Rumahmu Seperti Kebun</h1>
                                    <a href="" class="btn btn-primary py-sm-3 px-sm-4">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">Buat Kebun di Rumahmu Sendiri dari sini </h1>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 col-md-7 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Beatae officia illo explicabo? Commodi distinctio sequi vel autem tenetur dolores dicta!</p>
                    <a class="btn btn-primary py-3 px-4" href="">Baca Selengkapnya</a>
                </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="fs-5 fw-bold text-primary">Kenapa Harus Memilih Kami?</p>
                    <h1 class="display-5 mb-4">Beberapa Alasan Mengapa Orang Memilih Kami!</h1>
                    <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit, explicabo praesentium est ratione voluptas doloribus.</p>
                    <a class="btn btn-primary py-3 px-4" href="">Baca Selengkapnya</a>
                </div>
                <div class="col-lg-6">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Beberapa Project Kami</h1>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl.in Aja</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+62 567 786 0000</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>KebunKu@gmail.com</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">KebunKu</a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>
